...
//
//	mockgen -typed -package quic -self_package github.com/yogesh-prabu/quic-go-utls -self_package github.com/yogesh-prabu/quic-go-utls -destination mock_packetconn_test.go net PacketConn
//
